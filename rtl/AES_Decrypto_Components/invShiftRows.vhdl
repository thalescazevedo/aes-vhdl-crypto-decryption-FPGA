...
begin
    ...
    out_matriz(1, 0) <= in_matriz(1, 3);
    out_matriz(1, 1) <= in_matriz(1, 0);
    out_matriz(1, 2) <= in_matriz(1, 1);
    out_matriz(1, 3) <= in_matriz(1, 2);
    ...
    -- LINHA 3: Deslocamento de 3 bytes para a direita
    out_matriz(3, 0) <= in_matriz(3, 1);
    out_matriz(3, 1) <= in_matriz(3, 2);
    out_matriz(3, 2) <= in_matriz(3, 3);
    out_matriz(3, 3) <= in_matriz(3, 0);
